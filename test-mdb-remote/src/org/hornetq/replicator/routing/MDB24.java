...
(
    activationConfig =
    {
        ...
        @ActivationConfigProperty(propertyName = "clientId", propertyValue = "MDB24"),
		...
		@ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "receiver=24") })
@TransactionAttribute(value = TransactionAttributeType.REQUIRED)
public class MDB24 implements MessageListener {
