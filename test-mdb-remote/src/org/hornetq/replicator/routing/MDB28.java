...
(
    activationConfig =
    {
        ...
        @ActivationConfigProperty(propertyName = "clientId", propertyValue = "MDB28"),
		...
		@ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "receiver=28") })
@TransactionAttribute(value = TransactionAttributeType.REQUIRED)
public class MDB28 implements MessageListener {
