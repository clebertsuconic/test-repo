...
(
    activationConfig =
    {
        ...
        @ActivationConfigProperty(propertyName = "clientId", propertyValue = "MDB10"),
		...
		@ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "receiver=10"), })
@TransactionAttribute(value = TransactionAttributeType.REQUIRED)
public class MDB10 implements MessageListener {
