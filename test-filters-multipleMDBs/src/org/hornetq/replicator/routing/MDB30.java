...
(
    activationConfig =
    {
        ...
        @ActivationConfigProperty(propertyName = "clientId", propertyValue = "MDB30"),
		...
		@ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "receiver=30") })
@TransactionAttribute(value = TransactionAttributeType.REQUIRED)
public class MDB30 implements MessageListener {
