...
(
    activationConfig =
    {
        ...
        @ActivationConfigProperty(propertyName = "clientId", propertyValue = "MDB8"),
		...
		@ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "receiver=8") })
@TransactionAttribute(value = TransactionAttributeType.REQUIRED)
public class MDB8 implements MessageListener {
