...
(
    activationConfig =
    {
        ...
        @ActivationConfigProperty(propertyName = "clientId", propertyValue = "MDB29"),
		...
		@ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "receiver=29") })
@TransactionAttribute(value = TransactionAttributeType.REQUIRED)
public class MDB29 implements MessageListener {
