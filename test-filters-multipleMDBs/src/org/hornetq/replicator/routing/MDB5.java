...
(
    activationConfig =
    {
        ...
        @ActivationConfigProperty(propertyName = "clientId", propertyValue = "MDB5"),
		...
		@ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "receiver=5") })
@TransactionAttribute(value = TransactionAttributeType.REQUIRED)
public class MDB5 implements MessageListener {
